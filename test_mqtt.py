...
def send_image(client, topic, button, image_path):
...
def main():
    parser = argparse.ArgumentParser(description="Test MQTT integration for Ulanzi D200")
    parser.add_argument("--host", default="localhost", help="MQTT broker host")
    parser.add_argument("--user", default="", help="MQTT username")
    parser.add_argument("--passw", default="", help="MQTT password")
    parser.add_argument("--send-topic", default="ulanzi/receive", help="Topic to send images to (application's receive topic)")
    parser.add_argument("--receive-topic", default="ulanzi/send", help="Topic to receive events from (application's send topic)")
